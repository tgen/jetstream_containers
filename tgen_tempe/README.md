...
## Use Case: 
- Create Containers by Only Providing a Dockerfile
...
- 3b.) Use Existing Folder but Different Version
    - Use Same Folder name but different version. The python folder already exist but I’m creating a new version with a different tag
    ```
    # I want to create an image called python with version 3.10
    touch Individual_Images/p/python/3.10/Dockerfile
    ```
---
- 3.) Write out and configure the Dockerfile (READ <> FOR MORE INFO)
---
...
---
**Disclaimer**:
Update existing images will override any image on both Artifactory and Github Packages. Best Practice to update existing images will be to create a new folder at the version level with “v2" at the end of the tag. For example:
...
---
---
## Local Machine Instructions ( INTERNAL ):
---
### **How to create an image from a Dockerfile:**

    1.) sudo podman login --tls-verify=false pbc-art-prd01.ad.tgen.org

    2.) sudo buildah bud -t pbc-art-prd01.ad.tgen.org/$IMAGE:$VERSION -f Dockerfile

    3.) sudo podman push pbc-art-prd01.ad.tgen.org/hpc-local-containers/$IMAGE:$VERSION

### **How to pull an image from Artifactory:**
    1.) sudo podman login --tls-verify=false pbc-art-prd01.ad.tgen.org

    2.) sudo podman pull pbc-art-prd01.ad.tgen.org/hpc-virtual-containers/$IMAGE:$VERSION
---
## Local Machine Instructions ( EXTERNAL ):
---
### **How to create an image from a Dockerfile:**

    1.) sudo buildah bud -t ghcr.io/tgen/jetstream_containers/$IMAGE:$VERSION -f Dockerfile

    2.) sudo podman push --creds $GITHUB_USERNAME:$GITHUB_PERSONAL_ACCESS_TOKEN ghcr.io/tgen/jetstream_containers/$IMAGE:$VERSION

### **How to pull an image from Github:**

    1.) sudo podman pull --creds $GITHUB_USERNAME:$GITHUB_PERSONAL_ACCESS_TOKEN ghcr.io/tgen/jetstream_containers/$IMAGE:$VERSION
---
---
## Documentation
...
- [Resources - Jenkinsfile](https://gitlab01.tgen.org/oci-containers/resources/shared-library.git)
- [Resources - Scripts](https://gitlab01.tgen.org/oci-containers/resources/bash-scripts.git)
---